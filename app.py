...
def get_valid_kr_subcat(subcat):
    return subcat if subcat in KR_ALLOWED_SUBCATS else 'OTHER'

def get_valid_kr_country(country):
    return country if country in KR_ALLOWED_COUNTRIES else 'OTHER'
